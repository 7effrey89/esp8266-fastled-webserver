...
#define FASTLED_INTERNAL //Ved ikke hvad den bruges til
#include <FastLED.h>
...
#define DATA_PIN_C		D3
#define LED_TYPE_C		WS2812B
#define COLOR_ORDER_C		GRB

#define DEVICE_NAME 		"Treelight"
...
#define MATRIX_WIDTH		20	// Column count ( widest horizontal width for irregular matrix )
#define MATRIX_HEIGHT		3	// Row count ( tallest vertical height for irregular matrix )
...
void setup() {
	...
	#else
	FastLED.addLeds<LED_TYPE_C,DATA_PIN_C,COLOR_ORDER_C>(leds, NUM_LEDS).setCorrection(TypicalLEDStrip); //selv-defineret
